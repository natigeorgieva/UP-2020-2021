...
//Сравняваме всеки елемент от първия с всеки елемент от втрия масив	
	for (int j = 0; j < copy; j++)
	{
      ...
      //Затова елиминираме седмицата от втория масив, както направихме и в 7-ма задача
			...
			copy--;
			break;//Намерили сме вече сечение, няма смисъл да продължаваме, защото, ако има втори такъв елемент във втория масив, би се получил пък обратния случай
			//описан по-горе на този, (в първия масив да имаме две седмици, във втория една и сечението пак да са и двете)
		}
	}
